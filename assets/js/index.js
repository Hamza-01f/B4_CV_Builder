    ...
    const addressRegix = /^[A-Za-z0-9\s,.'-]{3,}$/i;
    const linksRegix = /^(https?:\/\/)?([\w-]+\.)+[a-z]{2,20}(\/[\w-]*)$/;  
    ...
    //----------------------------------------------[functions of creating dynamic form ]-----------------------------------------------------------
    // dynamic form function
        ...
        //soft skill dynamic form
            ...
            softSkillInput.placeholder = "Add Soft Skill "
        ...
        // degree and university dynamic form
            ...
            degreeInput.placeholder = "add degree";
            ...
            universityInput.placeholder = "add University";
        ...
        //job info dynamic form
            ...
            jobTitle.placeholder = "add job title";
            ...
            company.type = "text";
            company.id = "company";
            company.placeholder = "add company";
            ...
            durationt.placeholder = "add duration";
        ...
        // certifications dynamic form
            ...
            certifcationName.placeholder = "add Certification Name";
            ...
            certificationLink.placeholder = "add certificationLink";
    ...
    //-----------------------------------------------------------[functions of obtaining data from dynamic form ]---------------------------------------
    ...
    //----------------------[the part that is related to all functionalities of the pages from the first one till last one] ------------------
        ...
        //functionality of previous step goes here 
        document.querySelectorAll('button[id^="previous-step"]').forEach(button => {
        ...
        //functionality of next step goes here 
        document.querySelectorAll('button[id^="next-step"]').forEach(button => {
            button.addEventListener('click', function(e) {
              ...
              if(currentStep == 1){
                                         // Full Name
                                         if (fullName.value === '' || !FullNameRegix.test(fullName.value)) {
                                             fullName.value === '' ? fullNameError.textContent = "Please fill in your Full Name!" : fullNameError.textContent = "Please Enter a valid full Name!";
                                         ...
                                         // Job Title
                                         if (jobTitle.value === '' || !TitlesRegix.test(jobTitle.value)) {
                                         ...
                                         // Technical Skills
                                         if (technicalSkills.value === '' || !TitlesRegix .test(technicalSkills.value)) {
                                         ...
                                         // Soft Skills
                                         if (softSkills.value === '' || !TitlesRegix.test(softSkills.value)) {
                                         ...
                                         // Language
                                         if (language.value === '' || !LanguageLevelRegix.test(language.value)) {
                                         ...
                                         // Language Level
                                         if (languageLevel.value === '' || !LanguageLevelRegix.test(language.value)) {
                                         ...
                                         // Degree
                                         if (degree.value === '' || !TitlesRegix.test(degree.value)) {
                                         ...
                                         // University
                                         if (university.value === '' || !TitlesRegix.test(university.value)) {
                                         ...
                                         if (job.value === '' || !TitlesRegix.test(job.value)) {
                                         ...
                                         // // Certification Name
                                         if (certificationName.value === '' || !TitlesRegix.test(certificationName.value)) {
        ...
        function generateCV() {
            ...
            ${CvContent}
                ...
                <div class="flex justify-center gap-10 h-12 mt-8">
                    <!-- Previous Button -->
                    <button type="button" id="previous-step8" 
                        class="inline-block bg-gradient-to-r from-lime-500 to-green-500 text-slate-950 py-3 px-8 rounded-lg text-lg font-semibold hover:bg-gradient-to-l hover:from-cyan-500 hover:to-purple-500 transition-all duration-300 transform hover:scale-105 shadow-lg">
                        Previous
                    </button> 
            ...
            // this allows to return back to last step
            document.getElementById('previous-step8').addEventListener('click', function(){
                ...
                if (!downloadCv) {
                    console.error('CV content div not found');
                }
                ...
                btnDownload.addEventListener('click', async function () {
                    ...
                    try {
                        await html2pdf().set(options).from(downloadCv).save();
                    } catch (error) {
